    ...
    <div className='row row-iphone'>
        <ul className='list'>
            ...
            <li>Woman’s Fashion 
              ...
              <img src={Images.dropdown} height="15" width="15" className='mt-2' />
            </div>
            <div className='d-flex'>
            <li>Men’s Fashion            
            </li>
      ...
      <div className='iphone14'>
           ...
           <div className='col-5'>
            ...
            <img src={Images.symbol} height="49" width="40" />
            <h5>iPhone 14 Series</h5>
            </div>
            <div className='alink mt-4'>
            <h2> Up to 10% off Voucher</h2>
            <a href='/' className='alink mt-5' color='white'>Shop Now</a>
            <img src={Images.shopnow} height="30" width="30" />
            </div>
            </div>
            <div className='col-6'>
                <img src={Images.iphone} height="352px" width="496px" />
           </div>
