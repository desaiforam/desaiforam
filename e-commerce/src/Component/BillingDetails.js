...
const BillingDetails = () => {
  ...
  const listAdded = addToCart.map((id, color) =>
  ...
  return (
    <div>
      ...
      <div className="container d-flex flex-column">
        ...
        <div className="heading d-flex">Billing Details</div>
        <div
                    ...
                    return (
                      <>
                        <div className="crabbily">
                          ...
                          <div className="moniker">{item?.price}</div>
                        </div>
                      </>
                    );
                  })}
