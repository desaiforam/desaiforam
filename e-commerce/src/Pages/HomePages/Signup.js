...
//how to get the the user can already sign in on the web using firebase  in react js
//that user can sign up it will change name of logout 
//without sign up user can not a product add to cart useing firebase  
